...
// DJS -- Code by Dr Fayzullin. Extracted by DJS into a function.
/** GetCpuStatus() ********************************************/
/** Displays the current status of the processor, including  **/
/** registers, stack pointer, program counter, status regs   **/
/**************************************************************/
static void ShowCpuStatus(M6502 *R, char *S, int J, byte F)
{
  printf
  (
