...
private:
    ...
    const word DRB_ADDR = 0xA800;
    const word DRB_TE9 = 0x80;
    const word DRB_TE10 = 0x40;
    const word DRB_PB3 = 0x10;
    const word DRB_MASK = 0x3C;
    const word DRAH_ADDR = 0xA801;
